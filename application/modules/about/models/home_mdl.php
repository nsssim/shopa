...
class home_mdl extends CI_Model
{
		...
		$qry_combo = '
					select min(product_id) as prod_id,product_idd,product_price,product_sale_price,in_stock,product_image,product_name,product_description from (
					SELECT
					products.id as product_id,
					products.idd as product_idd,
					products.price as product_price,
					products.salePrice as product_sale_price,
					products.inStock as in_stock,
					images_sizes_iphone.url as product_image,
			...
			AS alternative_images GROUP BY product_id
					';				
