				...
				<div class="col-sm-12">
					<div class="blog-post-area">
						...
						<div class="single-blog-post">
							...
							<h3 id="return_exchange_q1"><?php echo $words['question1']; ?>	</h3>
							<p><?php echo $words['answer1']; ?></p> 
							
							<h3 id="return_exchange_q2"><?php echo $words['question2']; ?></h3>
							<p><?php echo $words['answer2']; ?></p>
							 
							<h3 id="return_exchange_q3"><?php echo $words['question3']; ?></h3>
							<p><?php echo $words['answer3']; ?></p>
							
							<h3 id="return_exchange_q4"><?php echo $words['question4']; ?></h3>
							<p><?php echo $words['answer4']; ?></p>
						</div>
					</div>
				</div>	
			</div>
