	...
	<div class="collapse navbar-collapse js-navbar-collapse">
		<ul class="nav navbar-nav">
			<li class="dropdown mega-dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Brands <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				
				<ul class="dropdown-menu mega-dropdown-menu row">
					<li class="col-sm-12">
						<ul>
							<li class="dropdown-header">A-Z</li>  
		...
		<li><a href="<?php  echo base_url();?>product/get_category_decendents_products/<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a></li>
			...
			<li class="dropdown mega-dropdown">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">Bags <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
		...
		<li><a href="<?php  echo base_url();?>product/get_category_decendents_products/<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a></li>
			...
			<li class="dropdown mega-dropdown">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">Shoes <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
...
<li class="dropdown mega-dropdown">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">Jewellery & Accessories <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
...
<li class="dropdown mega-dropdown">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">BEAUTY<span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
...
<li class="dropdown mega-dropdown">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">Men <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
		...
		<li><a href="<?php  echo base_url();?>product/get_category_decendents_products/<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a></li>
			...
			<li class="dropdown mega-dropdown">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">Kids <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
