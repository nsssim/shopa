...
<html>
  <head>
    <title> ORDER ARRIVED WAREHOUSE - SHOPAMERIKA.COM   </title>
  ...
  <body>
    ...
    <div id="anchor_frame">
	    ...
	    <div id="main_frame" >
		    ...
		    <span style="color: #000000;"><?php echo $words['your_order']; ?><!--YOUR ORDER--></span> 
		    <span style="color: #ff0000;"><?php echo $words['arrived']; ?><!--ARRIVED--></span> 
		    <span style="color: #000000;"><?php echo $words['to_warehouse']; ?><!--TO WAREHOUSE--></span></h1>
		    <hr />
		    <div id="container" >
		      ...
		      <p><?php echo $words['dear']; ?><!--Dear--> <?php echo strtoupper($od->customer_first_name)." ". strtoupper($od->customer_last_name)   ?> ,</p>
			        <p>
				       ...
				       <?php echo $words['has_arrived']; ?><!-- has arrived to our warehouse. The status of all items in your order is listed below under shipment details.-->
				        <br>
