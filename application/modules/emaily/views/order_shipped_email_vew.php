<?php 
	...
	/*echo("<pre>");
	var_dump($tr_city_county_name_invoice);
	echo("</pre>");*/
	
	/*echo $tr_city_county_name_delivery[0]->city_name;*/
...
<html>
  <head>
    <title> ORDER SHIPPED - SHOPAMERIKA.COM   </title>
  ...
  <body>
    ...
    <div id="anchor_frame">
	    ...
	    <div id="main_frame" >
		    ...
		    <span style="color: #ff0000;"><?php echo $words['shipment']; ?><!--SHIPMENT--></span> 
		    ...
		    <div id="container" >
		      ...
		      <p><?php echo $words['dear']; ?><!--Dear--> <?php echo strtoupper($od->customer_first_name)." ". strtoupper($od->customer_last_name)   ?> ,</p>
			        <p>
				       ...
				       <?php echo $words['was_shipped']; ?><!-- was shipped. The status of all items in your order is listed below under shipment details.-->
				        <br>
					...
					<div class="tbl">
						...
						<p> &nbsp;</p>
						<p><strong> <?php echo $words['plz_note']; ?><!--PLEASE NOTE:--> </strong>  <?php echo $words['it_may_take']; ?> <!--It may take the carrier 24-48 hours to update its records with your tracking information.--></p>
					</div>
