...
<html>
  <head>
    <title> <?php echo $words['title']; ?> <!--ORDER CONFIRMATION - SHOPAMERIKA.COM -->  </title>
  ...
  <body>
    ...
    <div id="anchor_frame">
	    ...
	    <div id="main_frame" >
		    ...
		    <span style="color: #ff0000;"><?php echo $words['order']; ?></span> 
		    ...
		    <div id="container" >
		      ...
		      <p>Dear <?php echo strtoupper($od->customer_first_name)." ". strtoupper($od->customer_last_name)   ?> ,</p>
			        <p><?php echo $words['thank_u_for_shoppin']; ?><!--Thank you for shopping at--> 
			        <a class="" href="<?php echo base_url() ?>">ShopAmerika.com.</a> <?php echo $words['your_ordr_num']; ?><!--Your order #--><?php echo $od->order_id; ?>  <?php echo $words['was_shipped']; ?><!--was shipped. The status of all items in your order is listed below under shipment details.-->
			        <br><?php echo $words['u_can_view_ur_orders']; ?><!--You can view your order status and history at any time by visiting -->
			        <a class="" href="<?php echo base_url() ?>customer/myorders"><?php echo $words['my_orders']; ?><!--My Orders.--></a></p>
			        
					<div class="tbl">
						<?php include('order_details.php') ?>
						<p> &nbsp;</p>
						<p><strong><?php echo $words['plz_note']; ?><!--PLEASE NOTE:--> </strong>  <?php echo $words['it_may_take']; ?><!--It may take the carrier 72 hours to update its records with your tracking information.--></p>
					</div>
