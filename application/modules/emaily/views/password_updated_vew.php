...
<html>
  <head>
	<title> <?php echo $words['subject_email']; ?> <!--YOUR PASSWORD WAS RESET-->  </title> 
   ...
   <?php include('slogant.php') ?>
    ...
    <div id="anchor_frame">
	    ...
	    <div id="main_frame" >
		    ...
		    <h2 style="color: #5e9ca0;"> <span style="color: #000000;"><?php echo $words['your_pwd_is_reset']; ?><!--YOUR PASSWORD HAS BEEN RESET--></span> 		   </h2>
		    <hr />
		    <div id="container" >
		      ...
		      <p style="padding-left: 20px;" ><?php echo $words['dear']; ?><!--Dear--> <?php echo strtoupper($user->first_name)." ". strtoupper($user->last_name)   ?>,</p>
			        ...
			        <p style="padding-left: 20px;" >
			        	<?php echo $words['is_reset_p']; ?> <!--Your ShopAmerika.com. password has been reset--> 	
			        </p>
