...
{
	$meta_description = $minfo->description;
	$meta_keyworks = $minfo->keywords;
	$meta_title = $minfo->title;
	$viewport = $minfo->viewport;
}
?>
...
<!--____________________________________/ meta \____________________________________ -->
    <meta charset="utf-8">
    <meta name="viewport" content="<?php echo($meta_keyworks) ?>" >
    <meta name="description " content="<?php echo($meta_description) ?> " >
	<meta name="keywords" content="<?php echo($meta_keyworks) ?>" >
    <meta name="trendit" content="baked with love" >
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src= "<?php echo base_url().'assets/templates/eshopper/images/home/logo.png';?>"  alt="" /></a>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="<?php echo base_url().'assets/templates/eshopper/images/home/product1.jpg';?>"  alt="" />
											<h2>$56</h2>
