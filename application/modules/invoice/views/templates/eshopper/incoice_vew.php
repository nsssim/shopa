	...
	<section id="cart_items">
		<div class="container">
			<div class="breadcrumbs">
				...
				<?php 	if($is_empty) echo "<h2>your cart is empty</h2>";  ?>
				...
				<table class="table table-condensed">
					...
					<tr id="<?php 	echo($item['rowid'])  ?>" class="crow" >
							...
							<td class="cart_description">
								<h4><a id=  <?php 	echo '"'. $item['id'].'"';  ?> href=""> <?php 	echo($item['name'])  ?> </a></h4>    
								<p> ID: <?php	echo($item['web_id'])  ?>  </p>
							</td>
							<td class="cart_price">
		 ...
		 //$(".cart_quantity_up").click(function()
			//{
				...
				var target_url = '<?php echo(base_url()."cart/add") ; ?>';
			  	...
			  	// get the product id from the DOM
			  	var prod_id =  $(this).parent().parent().prev().find("a").attr("id");
			  	alert(prod_id);
			  	var qty = $(this).next().attr("value");
