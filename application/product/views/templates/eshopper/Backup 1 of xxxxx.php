...
<!--____________________________________/ meta \____________________________________ -->  
    ...
    <meta name="description " content="xxxxxxxxxyyyyxxxxxxxxxxxxxxxxxx <?php // echo($product_details->seo_description); ?> " >
	<meta name="keywords" content="xxxxxxxxxxxx <?php // echo($meta_keyworks) ?>" >
...
<!--____________________________________/ title \____________________________________ -->
    <title> xxxxxxxxxxxxxxxxxxxxxxxxxxxx  <?php //echo($product_details->seo_name) ?> </title>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img  src="<?php echo($product_alt_img[0]->image); ?>"  alt="" />
								<h3>ZOOM</h3>
							</div>
							<div " id="similar-product" class="carousel slide" data-ride="carousel">
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
								    	...
								    	<?php
								    	 foreach ($product_alt_img as $alt_img) : ?>
										  <a href=""> <img  src="<?php echo($alt_img->alt_image); ?>"  alt="" /> </a>
										<?php  endforeach;	?>
										</div>
