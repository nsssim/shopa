...
<!--____________________________________/ css \____________________________________-->
	...
	<!--islam single_vew-->
	<!--<link href="<?php echo $secure_base_url.'assets/zoom/css/cloudzoom.css';?>"  rel="stylesheet">
	<link href="<?php echo $secure_base_url.'assets/zoom/css/thumbelina.css';?>" rel="stylesheet">-->
	
	<!--magic zoom-->
	<link href="<?php echo $secure_base_url.'assets/templates/eshopper/magiczoomplus/magiczoomplus.css';?>" rel="stylesheet">
	
	<!--thumbnail slider-->
	<link href="<?php echo $secure_base_url.'assets/templates/eshopper/thumbnailslider/1/thumbnail-slider.css';?>" rel="stylesheet">
	<link href="<?php echo $secure_base_url.'assets/templates/eshopper/thumbnailslider/1/thumbs2.css';?>" rel="stylesheet">
	
	<!--opentip tooltip-->
	<link href="<?php echo $secure_base_url.'assets/templates/eshopper/opentip/opentip.css';?>" rel="stylesheet">
	
	<!--hint.css-->
	<link href="<?php echo $secure_base_url.'assets/templates/eshopper/css/hint.min.css';?>" rel="stylesheet">
