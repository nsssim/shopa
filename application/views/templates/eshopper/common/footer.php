			...
			<div class="footer-widget">
					...
					<div class="row">
						...
						<div class="col-sm-1 " class="vdots" style="positio: absolute;max-height: 250px; overflow-y: hidden;  ">
							<img src="<?php echo base_url().'assets/templates/eshopper/images/common/vdots.png' ?>" />
						</div>
						
						<div class="col-sm-3 ">
							<div class="single-widget">
								<img width="100%" src='<?php echo base_url().$words["customer_service_img"]; ?>' />
								<div style="overflow-x: hidden;" >	<img src="<?php echo base_url().'assets/templates/eshopper/images/common/hzdots.png' ?>" />	</div>
								<div>
									<!--input-->
									<div class="col-sm-12 " style="padding: 0; margin-top: 5px;" >
										<div class="col-sm-10 " style="padding: 0;" >
											...
											<span id="email_footer_error" style="display: none;">  <?php echo $words["error_email"]; ?> 	 <!--please enter a valid email-->  </span>
											<span id="email_footer_ok" style="display: none;">     <?php echo $words["thank_you"]; ?> 		 <!--thank you for registering!--> </span>
											<span id="email_footer_ok2" style="display: none;">    <?php echo $words["alredy_registred"]; ?> <!--thank you, you're already regitered!--> </span>
										</div>
										<div class="col-sm-2 " id="clctem" style="padding:0;margin:0 ; background-color: #ff0000; color: white;text-align: center; cursor: pointer;" ><span  style=" line-height:36px; text-align: center;" > <i class="fa fa-arrow-circle-o-right" style="line-height:36px;" ></i> </span>	</div>
									</div>
									<!--/input-->
