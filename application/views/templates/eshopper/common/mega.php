	...
	<div class="collapse navbar-collapse js-navbar-collapse">
		<ul class="nav navbar-nav" style="width: 1024px;">
			...
			<a href="<?php  echo base_url();?>brands/brands_list" class="dropdown-toggle"><?php echo $words["brands"];?> <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				...
				<ul class="dropdown-menu mega-dropdown-menu">
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/women/06.jpg';?>"/>
								</div>
							</div>
							<div class="row"> 
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									...
									<img src="<?php echo base_url().'assets/templates/eshopper/images/brands/brands.png';?>" />
									</div>
									<!--<ul>
			...
			<a href="<?php  echo base_url();?>product/browse/?cat_id=2" class="dropdown-toggle">
				...
				<ul class="dropdown-menu mega-dropdown-menu">
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/women/04.jpg';?>"/>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
			...
			<a href="<?php  echo base_url();?>product/browse/?cat_id=31" class="dropdown-toggle"><?php echo $words["bags"];?> <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				...
				<ul class="dropdown-menu mega-dropdown-menu">
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/bags/03.jpg';?>"/>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
		...
		<li class="dropdown mega-dropdown"> <!--ACCESSORIES-->
			<a href="<?php  echo base_url();?>product/browse/?cat_id=3" class="dropdown-toggle"><?php echo $words["accessories"];?> <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				...
				<ul class="dropdown-menu mega-dropdown-menu">
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/jewelery/03.jpg';?>"/>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<h5><?php echo $words["women"];?></h5>
									<ul>
										<?php foreach ($categories['women_accessories_cat'] as $cat) : ?>
										<li>
											<a href="<?php  echo base_url();?>product/browse/?cat_id=<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a>
										</li>
										<?php endforeach; ?>
									</ul>
									<h5><?php echo $words["men"];?></h5>
		...
		<li><a href="<?php  echo base_url();?>product/browse/?cat_id=<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a></li>
								...
								<div class="col-sm-6">
									<!--<h5>WHAT'S NEW </h5>
									<ul>
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=65&s=101&s=100 "> New Arrivals </a> </li> 
										
									</ul>
									<hr/>-->
									<!--<h5><?php echo $words["sale"];?></h5>
									<ul>
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=65&s=0 "> See All </a> </li> 
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=65&s=0&s=100 "> Today! </a> </li> 
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=65&s=0&s=101 "> This week! </a> </li> 
									</ul>-->
		...
		<li class="dropdown mega-dropdown"> <!--BEAUTY-->
			<a href="<?php  echo base_url();?>product/browse/?cat_id=413" class="dropdown-toggle"><?php echo $words["beauty"];?> <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				...
				<ul class="dropdown-menu mega-dropdown-menu">
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/women/11.jpg';?>"/>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
		...
		<li><a href="<?php  echo base_url();?>product/browse/?cat_id=<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a></li>
								...
								<div class="col-sm-6">
									...
									<!--<h5><?php echo $words["sale"];?> </h5>
									<ul>
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=413&s=0 "> See All </a> </li> 
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=413&s=0&s=100 "> Today! </a> </li> 
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=413&s=0&s=101 "> This week! </a> </li> 
									</ul>-->
		...
		<li><a href="<?php  echo base_url();?>product/browse/?cat_id=<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a></li>
								...
								<div class="col-sm-6">
									...
									<ul>
										...
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=166&s=0&s=101 "> This week! </a> </li> 
									</ul>
									<!--<hr/>-->
									<!--<h5>FEATURED ITEMS <font size="2px" color="red">soon</font></h5>
									<ul>
			...
			<a href="<?php  echo base_url();?>product/browse/?cat_id=323" class="dropdown-toggle"><?php echo $words["kids"];?> <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				...
				<ul class="dropdown-menu mega-dropdown-menu">
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/kids/02.jpg';?>"/>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
					...
					<li><a href="<?php  echo base_url();?>product/browse/?cat_id=<?php echo $cat->main_id;?>"><?php echo $cat->name;?> </a></li>
								...
								<div class="col-sm-6">
									...
									<ul>
										...
										<li><a href=" <?php echo base_url();?>product/browse/?cat_id=323&s=0&s=101 "> This week! </a> </li> 
									</ul>
									<!--<hr/>-->
									<!--<h5>FEATURED ITEMS <font size="2px" color="red">soon</font></h5>
									<ul>
			...
			<a href="<?php  echo base_url();?>product/browse/?cat_id=806" class="dropdown-toggle"><?php echo $words["home"];?> <span class="glyphicon glyphicon-chevron-down pull-right"></span></a>
				...
				<ul class="dropdown-menu mega-dropdown-menu" >
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/home/04.jpg';?>"/>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
			...
			<a href="<?php  echo base_url();?>product/browse/?cat_id=2&s=0" class="dropdown-toggle pull-right"><?php echo $words["sale"];?> <span class="glyphicon glyphicon-chevron-down "></span></a>
				...
				<ul class="dropdown-menu mega-dropdown-menu">
							<div class="row">
								<div class="col-sm-12">
									<img src="<?php echo base_url().'assets/templates/eshopper/banner/women/09.jpg';?>"/>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
