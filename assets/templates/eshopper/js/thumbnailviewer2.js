...
jQuery.thumbnailviewer2={
		//loadmsg: '<img src="/usa/assets/templates/eshopper/images/product-details/spinningred.gif" /><br />Loading Large Image...', //HTML for loading message. Make sure image paths are correct
		loadmsg: '<img src="'+sa_base_url+'/assets/templates/eshopper/images/product-details/spinningred.gif" /><br />Loading Large Image...', //HTML for loading message. Make sure image paths are correct

	/////NO NEED TO EDIT BEYOND HERE////////////////

	dsetting: {trigger:'mouseover', preload:'yes', fx:'fade', fxduration:500, enabletitle:'yes'}, //default settings
	buildimage:function($, $anchor, setting){
		var imghtml='<img src="'+$anchor.attr('href')+'" style="border-width:0;object-fit: contain;height: 350px;width: 200px" />'
		if (setting.link)
